...
def limpiar_pantalla():
    # Limpiar pantalla en sistemas Unix (Linux, macOS)
    if os.name == 'posix':
        os.system('clear')
...
def imprimir_matrices_con_barcos(matriz_j1):
...
def jugar():
    ...
    cantidad_barcos = 5
    matriz_j1 = obtener_matriz_inicial()
    ...
    while True:
        ...
        if acertado:
            ...
            if todos_los_barcos_hundidos(matriz_oponente):
                ...
                imprimir_matrices_con_barcos(matriz_j1)
                break
        else:
...
def acerca_de():
    print("Programado por Luis Cabrera Benito y modificado por Ricardo Sierra Roa")
